...
if __name__ == "__main__":
    ...
    if args.judge_model == "cohere":
        ...
        judge_tokenizer = AutoTokenizer.from_pretrained(
            "CohereForAI/c4ai-command-r-plus", cache_dir="./models", device_map="cuda",
        )
    ...
    if args.mode == "single":
        ...
        output_file = (
            f"FastChat/fastchat/llm_judge/data/{args.bench_name}/model_judgment/{args.judge_model}_single.jsonl"
        )
        ...
        output_file = (
            f"FastChat/fastchat/llm_judge/data/{args.bench_name}/model_judgment/{args.judge_model}_pair.jsonl"
        )
